...
function App() {
    ...
    const [isTwoDepthBottomsheetShow, setIsTwoDepthBottomsheetShow] =
        useState(false);
                ...
                <Routes>
                    ...
                    >
                        <Route
                            path="/auth/kakao"
                            element={
                                <KakaoAuthHandle setIsLogin={setIsLogin} />
                            }
                        ></Route>
                        ...
                        <Route
                            path="/diary"
                            element={<ComingSoon type="diary" />}
                        ></Route>
                        <Route
                            path="/recipe"
                            element={<ComingSoon type="recipe" />}
                        ></Route>
                        <Route
                            path="/refrigerator"
                            element={
                        ...
                        ></Route>
                        <Route
                            path="/refrigerator/edit"
                            element={<RefrigeratorEdit />}
                        ></Route>
